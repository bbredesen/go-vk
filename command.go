// Code generated by go-vk from vk-1.3.242.xml at 2023-03-31 10:23:48.1902876 -0500 CDT m=+2.874087501. DO NOT EDIT.
...
func GetImageSubresourceLayout2EXT(device Device, image Image, subresource *ImageSubresource2EXT) (layout SubresourceLayout2EXT) {
	...
	execTrampoline(vkGetImageSubresourceLayout2EXT, uintptr(device), uintptr(image), uintptr(unsafe.Pointer(pSubresource)), uintptr(unsafe.Pointer(pLayout)))

	layout = *(pLayout.Goify())
	return
}

var vkGetImageSubresourceLayout2EXT = &vkCommand{"vkGetImageSubresourceLayout2EXT", 4, true, nil}
