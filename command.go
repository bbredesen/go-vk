// Code generated by go-vk from vk-1.2.203.xml at 2023-03-16 13:28:31.924758 -0600 MDT m=+1.954966524. DO NOT EDIT.
...
const (
	...
	keyvkGetDeviceBufferMemoryRequirementsKHR
	keyvkGetDeviceGroupPeerMemoryFeatures
	keyvkGetDeviceGroupPresentCapabilitiesKHR
	keyvkGetDeviceGroupSurfacePresentModesKHR
	keyvkGetDeviceImageMemoryRequirementsKHR
	keyvkGetDeviceImageSparseMemoryRequirementsKHR
...
func init() {
	...
	lazyCommands[keyvkCmdBeginRenderingKHR] = vkCommand{"vkCmdBeginRenderingKHR", 2, true, nil}
	...
	lazyCommands[keyvkCmdEndRenderingKHR] = vkCommand{"vkCmdEndRenderingKHR", 1, true, nil}
	...
	lazyCommands[keyvkGetDeviceBufferMemoryRequirementsKHR] = vkCommand{"vkGetDeviceBufferMemoryRequirementsKHR", 3, true, nil}
	...
	lazyCommands[keyvkGetDeviceImageMemoryRequirementsKHR] = vkCommand{"vkGetDeviceImageMemoryRequirementsKHR", 3, true, nil}
	lazyCommands[keyvkGetDeviceImageSparseMemoryRequirementsKHR] = vkCommand{"vkGetDeviceImageSparseMemoryRequirementsKHR", 4, true, nil}
...
func CmdBeginRenderingKHR(commandBuffer CommandBuffer, renderingInfo *RenderingInfoKHR) {
	...
	execTrampoline(keyvkCmdBeginRenderingKHR, uintptr(commandBuffer), uintptr(unsafe.Pointer(pRenderingInfo)))
...
func CmdEndRenderingKHR(commandBuffer CommandBuffer) {
	...
	execTrampoline(keyvkCmdEndRenderingKHR, uintptr(commandBuffer))
...
func GetDeviceBufferMemoryRequirementsKHR(device Device, info *DeviceBufferMemoryRequirementsKHR) (memoryRequirements MemoryRequirements2) {
	...
	execTrampoline(keyvkGetDeviceBufferMemoryRequirementsKHR, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pMemoryRequirements)))
...
func GetDeviceImageMemoryRequirementsKHR(device Device, info *DeviceImageMemoryRequirementsKHR) (memoryRequirements MemoryRequirements2) {
	...
	execTrampoline(keyvkGetDeviceImageMemoryRequirementsKHR, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pMemoryRequirements)))
...
func GetDeviceImageSparseMemoryRequirementsKHR(device Device, info *DeviceImageMemoryRequirementsKHR) (sparseMemoryRequirements []SparseImageMemoryRequirements2) {
	...
	execTrampoline(keyvkGetDeviceImageSparseMemoryRequirementsKHR, uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pSparseMemoryRequirementCount)), uintptr(unsafe.Pointer(pSparseMemoryRequirements)))
