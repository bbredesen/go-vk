...
const _ImageUsageFlagBits_name = "IMAGE_USAGE_TRANSFER_SRC_BITIMAGE_USAGE_TRANSFER_DST_BITIMAGE_USAGE_SAMPLED_BITIMAGE_USAGE_STORAGE_BITIMAGE_USAGE_COLOR_ATTACHMENT_BITIMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BITIMAGE_USAGE_TRANSIENT_ATTACHMENT_BITIMAGE_USAGE_INPUT_ATTACHMENT_BITIMAGE_USAGE_VIDEO_DECODE_SRC_BIT_KHRIMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXTIMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHRIMAGE_USAGE_ATTACHMENT_FEEDBACK_LOOP_BIT_EXTIMAGE_USAGE_INVOCATION_MASK_BIT_HUAWEIIMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM"
...
var _ImageUsageFlagBits_map = map[ImageUsageFlagBits]string{
	...
	1000440000: _ImageUsageFlagBits_name[452:486],
}
...
const _ObjectType_name = "OBJECT_TYPE_UNKNOWNOBJECT_TYPE_INSTANCEOBJECT_TYPE_PHYSICAL_DEVICEOBJECT_TYPE_DEVICEOBJECT_TYPE_QUEUEOBJECT_TYPE_SEMAPHOREOBJECT_TYPE_COMMAND_BUFFEROBJECT_TYPE_FENCEOBJECT_TYPE_DEVICE_MEMORYOBJECT_TYPE_BUFFEROBJECT_TYPE_IMAGEOBJECT_TYPE_EVENTOBJECT_TYPE_QUERY_POOLOBJECT_TYPE_BUFFER_VIEWOBJECT_TYPE_IMAGE_VIEWOBJECT_TYPE_SHADER_MODULEOBJECT_TYPE_PIPELINE_CACHEOBJECT_TYPE_PIPELINE_LAYOUTOBJECT_TYPE_RENDER_PASSOBJECT_TYPE_PIPELINEOBJECT_TYPE_DESCRIPTOR_SET_LAYOUTOBJECT_TYPE_SAMPLEROBJECT_TYPE_DESCRIPTOR_POOLOBJECT_TYPE_DESCRIPTOR_SETOBJECT_TYPE_FRAMEBUFFEROBJECT_TYPE_COMMAND_POOLOBJECT_TYPE_SURFACE_KHROBJECT_TYPE_SWAPCHAIN_KHROBJECT_TYPE_DISPLAY_KHROBJECT_TYPE_DISPLAY_MODE_KHROBJECT_TYPE_DEBUG_REPORT_CALLBACK_EXTOBJECT_TYPE_VIDEO_SESSION_KHROBJECT_TYPE_VIDEO_SESSION_PARAMETERS_KHROBJECT_TYPE_CU_MODULE_NVXOBJECT_TYPE_CU_FUNCTION_NVXOBJECT_TYPE_DESCRIPTOR_UPDATE_TEMPLATEOBJECT_TYPE_DEBUG_UTILS_MESSENGER_EXTOBJECT_TYPE_ACCELERATION_STRUCTURE_KHROBJECT_TYPE_SAMPLER_YCBCR_CONVERSIONOBJECT_TYPE_VALIDATION_CACHE_EXTOBJECT_TYPE_ACCELERATION_STRUCTURE_NVOBJECT_TYPE_PERFORMANCE_CONFIGURATION_INTELOBJECT_TYPE_DEFERRED_OPERATION_KHROBJECT_TYPE_INDIRECT_COMMANDS_LAYOUT_NVOBJECT_TYPE_PRIVATE_DATA_SLOTOBJECT_TYPE_MICROMAP_EXTOBJECT_TYPE_OPTICAL_FLOW_SESSION_NVOBJECT_TYPE_SHADER_EXT"
...
var _ObjectType_map = map[ObjectType]string{
	...
	1000482000: _ObjectType_name[1261:1283],
}
