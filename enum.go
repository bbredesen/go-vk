// Code generated by go-vk from vk.xml at 2023-01-14 10:53:48.5471672 -0600 CST m=+1.238464201. DO NOT EDIT.
package vk

//go:generate stringer -output=enum_string_0.go -type=AccessFlagBits,AttachmentDescriptionFlagBits,AttachmentLoadOp,AttachmentStoreOp,BlendFactor,BlendOp,BorderColor,BufferCreateFlagBits,BufferUsageFlagBits,ColorComponentFlagBits,CommandBufferLevel,CommandBufferResetFlagBits,CommandBufferUsageFlagBits,CommandPoolCreateFlagBits,CommandPoolResetFlagBits,CompareOp,ComponentSwizzle,CullModeFlagBits,DependencyFlagBits,DescriptorPoolCreateFlagBits,DescriptorType,DynamicState,FenceCreateFlagBits,Filter,Format,FormatFeatureFlagBits,FrontFace,ImageAspectFlagBits,ImageCreateFlagBits,ImageLayout,ImageTiling
//go:generate stringer -output=enum_string_1.go -type=ImageType,ImageUsageFlagBits,ImageViewType,InternalAllocationType,LogicOp,MemoryHeapFlagBits,MemoryPropertyFlagBits,ObjectType,PhysicalDeviceType,PipelineBindPoint,PipelineCacheHeaderVersion,PipelineCreateFlagBits,PipelineStageFlagBits,PolygonMode,PrimitiveTopology,QueryControlFlagBits,QueryPipelineStatisticFlagBits,QueryResultFlagBits,QueryType,QueueFlagBits,Result,SampleCountFlagBits,SamplerAddressMode,SamplerMipmapMode,ShaderStageFlagBits,SharingMode,SparseImageFormatFlagBits,SparseMemoryBindFlagBits,StencilOp,StructureType,SystemAllocationScope
//go:generate stringer -output=enum_string_2.go -type=VendorId,VertexInputRate
